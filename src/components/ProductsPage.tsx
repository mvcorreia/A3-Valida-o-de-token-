...
const ProductsPage = () => {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      ...
      case "rating":
        sorted.sort(
          (a, b) =>
            getProductReviews(b.id).average - getProductReviews(a.id).average,
        );
        break;
      default:
        break;
  ...
  const handleToggleFavorite = (e: React.MouseEvent, product: Product) => {
    ...
    toast.success(
      wasFav ? "Removido dos favoritos" : `${product.name} salvo nos favoritos`,
    );
  };
    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-10 bg-background/85 backdrop-blur-lg border-b">
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <Heart
                className={`w-4 h-4 ${favorites.length > 0 ? "fill-primary text-primary" : ""}`}
              />
      ...
      <main className="container py-8 animate-fade-in">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--primary) / 0.7) 60%, hsl(var(--accent)) 100%)",
          }}
        >
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-5">
            <div className="text-primary-foreground">
              ...
              <h2 className="font-heading text-2xl sm:text-3xl leading-tight">
                Até{" "}
                <span className="text-4xl sm:text-5xl font-bold">30% OFF</span>{" "}
                em Eletrônicos
              </h2>
          ...
          <section className="mb-10 animate-fade-in">
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl sm:text-2xl font-heading">
                  Produtos em destaque
                </h2>
              </div>
            ...
            {filtered.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Heart
                      className={`w-4 h-4 ${isFav ? "fill-primary text-primary" : "text-muted-foreground"}`}
                    />
                  </button>
                  ...
                  >
                    ...
                    <h3 className="font-heading text-lg mt-2 line-clamp-1">
                      {product.name}
                    </h3>
